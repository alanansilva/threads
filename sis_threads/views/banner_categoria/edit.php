...
$obj = $data->getBannerCategoria($_REQUEST['id']);
	      ...
	      <div class="row">
            <div class="col-md-12">
                <h5 class="h5_tit_bor_bottom">
                    Editar banner_categoria
                </h5>
            </div>
        </div>
				<form id="form_banner_categoria" name="form_banner_categoria" method="post" action="<?php echo $link?>/edit" role="form">
