...
CREATE TABLE `imagem` (
  ...
  CONSTRAINT `fk_imagem_2` FOREIGN KEY (`relacionamento_id`) REFERENCES `conteudo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-10-15 13:25:41
